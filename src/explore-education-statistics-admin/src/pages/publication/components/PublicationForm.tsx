...
const PublicationForm = ({
  ...
  const validationSchema = useMemo(() => {
    const schema = z.object({
      title: z.string({
        required_error: 'Enter a publication title',
      }),
      summary: z
        .string({
          required_error: 'Enter a publication summary',
        })
      ...
      teamEmail: z
        .string({
          required_error: 'Enter a team email address',
        })
      ...
      contactTelNo: z.string({
        required_error: 'Enter a contact telephone number',
      }),
      supersededById: z.string().optional(),

      topicId: initialValues?.topicId ? z.string() : z.string().optional(),
    });
