  ...
  return (
    <Formik<FormValues>
      ...
      validationSchema={z.object<FormValues>({
        name: z.string({
          required_error: 'Enter a data block name',
        }),
        isHighlight: z.boolean(),
        highlightName: z.string().when('isHighlight', {
          is: true,
          then: s => s.required('Enter a featured table name'),
        }),
        highlightDescription: z.string().when('isHighlight', {
          is: true,
          then: s => s.required('Enter a featured table description'),
        }),
        heading: z.string({
          required_error: 'Enter a table title',
        }),
        source: z.string(),
      })}
