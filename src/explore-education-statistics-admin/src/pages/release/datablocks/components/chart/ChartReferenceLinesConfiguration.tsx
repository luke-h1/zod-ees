      ...
      <tbody>
        ...
        {(filteredOptions.length > 0 || type === 'minor') && (
          <Formik<AddFormValues>
            ...
            validationSchema={z.object<AddFormValues>({
              label: z.string({
                required_error: 'Enter label',
              }),
              otherAxisPosition: z.number().refine(value => {
              ...
              position: z
                .string({
                  required_error: 'Enter position',
                })
                .refine(value => {
                  return type === 'minor' && minorAxisDomain
                    ? Number(value) >= minorAxisDomain?.min &&
                        Number(value) <= minorAxisDomain.max
                    : true;
                }),

              style: z.enum(['dashed', 'solid', 'none'], {
                required_error: 'Select style',
              }),
            })}
